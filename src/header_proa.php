...
<body>
  ...
  <nav class="navbar">
    <div class="nav__left">
      <a href="calendario.php"> <!-- html de página principal -->
        <img src="img/PROA.png" class="nav__left__logo" alt="ProA" /> 
      </a>
      <!-- botones de asignaturas con svg estrellas en navbar -->
      <div class="nav__left__links">
        <a href="tareas.php" class="nav__left__link">
    ...
    <div class="nav__right">
      <!-- muestra el nombre del usuario que se ha logeado -->
      ...
      <div class="dropdown-menu">
        ...
        <!-- este enlace sirve para cambiar la visa de profesor a alumno  -->
        <a href="#" class="dropdown-item" id="cambiar-vista">Cambiar a Alumno</a>
  ...
  <nav class="navbar-secondary">
    <a href="calendario.php" class="navbar-secondary__link navbar-secondary__link--current">CALENDARIO GLOBAL</a>
    <a href="cuenta.php" class="navbar-secondary__link">CUENTA</a>
    <a href="incidencias.php" class="navbar-secondary__link">INCIDENCIAS</a>
  </nav>

//==================================================================================================================================
//                                        AQUI EMPIEZA EL CÓDIGO DEL CALENDARIO
//==================================================================================================================================
    ...
    { id: 2, estado: "enviada", fecha_apertura: "10/05/2025", fecha_cierre: "1/05/2025", fecha_entrega: "13/05/2025", nickname: "marc", descripción: "tienes que hacer los programas 1 y 2 ", tipo_tarea: "practico", ID_asignatura: "programación", nombre: "Tarea_2" }]};
      ...
      for (let i = 1; i <= 35; i++) {
        ...
        //Este else es todo el cuerpo del calendario
          ...
          for (llave of eventos_del_dia){
            contenidoHTML += `<div class="evento" data-type="${llave.tipo_tarea}">${llave.ID_asignatura}</div>`;
          }
          ...
          celda.addEventListener('click', () => {
            ...
            let textoInfo = `Día seleccionado: ${dia_actual} ${meses[mes]} ${año}<ul>`;

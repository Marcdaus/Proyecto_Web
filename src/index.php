...
<head>
    ...
    <link rel="stylesheet" href="./css/estilo_gti.css">
...
<main class="sobre_proa" id="sobre_proa">
  <div class="texto-principal">
    <h1>
      PROA, la herramienta web que solventa los problemas <br>de comunicación entre los docentes y sus alumnos.
    </h1>
  </div>
  <div class="cajas">
    <div class="caja">
  ...
  <div class="cta">
    <h2>PRUEBA PROA</h2>
    <a href="login.php"><button>DEMO</button></a>
  </div>
</main>
...
<section id="accesibilidad" class = "accesibilidad">
    ...
    <ul>
        <li>
            ...
            <ul>
                <li><img src="img/color 1.png" alt="Color azul claro"></li>
                <li><img src="img/color 2.png" alt="Color azul principal"></li>
                <li><img src="img/color 3.png" alt="Color gris"></li>
            </ul>
        ...
        <li>
            ...
            <ul>
                <li><img src="img/color 4.png" alt="Color azul"></li>
                <li><img src="img/color 5.png" alt="Color azul oscuro"></li>
                <li><img src="img/color 6.png" alt="Color gris más oscuro"></li>
            </ul>
            <!-- añadir colores de ejemplo -->
        </li>
        <li>
            ...
            <ul>
                <li><img src="img/color 7.png" alt="Color azul claro"></li>
                <li><img src="img/color 8.png" alt="Color violeta"></li>
                <li><img src="img/color 9.png" alt="Color mostaza"></li>
            </ul>
            <!-- añadir colores de ejemplo -->
        </li>
        <li class='otros'>
...
<main id="acerca_de_gti" class ="acerca_de_gti">
<div class='titulo-gti'><h1>Acerca de GTI</h1></div>
 <div class="acerca-gti">
    ...
    <div class="imagen1">
      <img src="img/gti1.jpg" alt="Imagen que acompaña acerca de GTI">
    </div>
  </div>

  <div class="actualidad">
    <div class="imagen2">
      <img src="img/gti2.jpg" alt="Imagen que acompaña GTI en la actualidad">
    </div>

...
async function validarCredenciales() {
    ...
    if (!nombre){errores.push("El nombre es obligatorio.");
        console.log("Error: el campo del nombre esta vacio"); }
    
    if (!institucion){ errores.push("La institución es obligatoria.");
        console.log("Error: el campo de institución esta vacio"); }

    if (!email){ errores.push("El email es obligatorio.");
        console.log("Error: el campo del email esta vacio"); }
    ...
    if(emailExiste){ errores.push("El email ya existe.");
        console.log("Error: cuenta ya registrada"); }
...
function validarContraseñas() {
    ...
    if (pass1.length < 9) {
        ...
        console.log("Error: La contraseña debe tener al menos 9 caracteres ");
    }

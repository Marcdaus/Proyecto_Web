...
async function Obtener(){
  ...
  return await response.json();
   ...
   //  eventos.tareas=Obtener()
    ...
    { id: 2, estado: "enviada", fecha_apertura: "10/05/2025", fecha_cierre: "1/05/2025", fecha_entrega: "13/05/2025", nickname: "marc", descripción: "tienes que hacer los programas 1 y 2 ", tipo_tarea: "practico", ID_asignatura: "programacion", nombre: "Tarea_2" }]};
